// ======================================================================
// EPROM_Reader.v generated from TopDesign.cysch
// 10/18/2019 at 15:55
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80"
`include "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80"
`include "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90"
`include "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90"
`include "C:\Program Files\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyStatusReg_v1_90\CyStatusReg_v1_90.v"
`endif
...
module top ;
    ...
    CyControlReg_v1_80 AddrLow (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam AddrLow.Bit0Mode = 0;
    defparam AddrLow.Bit1Mode = 0;
    defparam AddrLow.Bit2Mode = 0;
    defparam AddrLow.Bit3Mode = 0;
    defparam AddrLow.Bit4Mode = 0;
    defparam AddrLow.Bit5Mode = 0;
    defparam AddrLow.Bit6Mode = 0;
    defparam AddrLow.Bit7Mode = 0;
    defparam AddrLow.BitValue = 0;
    defparam AddrLow.BusDisplay = 0;
    defparam AddrLow.ExtrReset = 0;
    defparam AddrLow.NumOutputs = 8;

    CyControlReg_v1_80 AddrHigh (
        .control_1(Net_69),
        .control_2(Net_70),
        .control_3(Net_71),
        .control_0(Net_68),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam AddrHigh.Bit0Mode = 0;
    defparam AddrHigh.Bit1Mode = 0;
    defparam AddrHigh.Bit2Mode = 0;
    defparam AddrHigh.Bit3Mode = 0;
    defparam AddrHigh.Bit4Mode = 0;
    defparam AddrHigh.Bit5Mode = 0;
    defparam AddrHigh.Bit6Mode = 0;
    defparam AddrHigh.Bit7Mode = 0;
    defparam AddrHigh.BitValue = 0;
    defparam AddrHigh.BusDisplay = 0;
    defparam AddrHigh.ExtrReset = 0;
    defparam AddrHigh.NumOutputs = 4;

    CyStatusReg_v1_90 DataInput (
        .status_0(Net_72),
        .status_1(Net_73),
        .status_2(Net_74),
        .status_3(Net_75),
        ...
        .intr(Net_30),
        .status_bus(8'b0));
    defparam DataInput.Bit0Mode = 0;
    defparam DataInput.Bit1Mode = 0;
    defparam DataInput.Bit2Mode = 0;
    defparam DataInput.Bit3Mode = 0;
    defparam DataInput.Bit4Mode = 0;
    defparam DataInput.Bit5Mode = 0;
    defparam DataInput.Bit6Mode = 0;
    defparam DataInput.Bit7Mode = 0;
    defparam DataInput.BusDisplay = 0;
    defparam DataInput.Interrupt = 0;
    defparam DataInput.MaskValue = 0;
    defparam DataInput.NumInputs = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("d8db5196-7951-422b-b56b-10792b5f3a96"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("e6ae5e47-5dfd-44a7-bf5a-c202ab4b1224"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2ab8d6b3-a76b-44a0-ac37-d9bdfe5bcb08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f8570b9c-dcc8-458c-826b-6badd8cb7844"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("228165d8-e738-4653-a56c-15a6b0822588"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("66a7f6b9-74b7-4c5a-aa49-af58e708b182"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cc79878c-128c-4f78-a5fe-c529d49d2b26"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ed934025-5a3c-4425-9c87-7583e99a7175"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b25fcb79-52d9-428f-b4c5-add1d58d41b9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0a23a5df-f012-4100-9405-dba6b35d0f6f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1f46ff71-2d29-4007-aba9-04d3d053593b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9b4c2f18-2a8b-4f58-870a-a2ee23ffcd34"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a8c72e0f-b718-4de5-bff3-93255dc167e3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6fdff91e-50c8-45dd-87ee-d07ebccf8aa1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7ed052b9-4f79-4af8-9299-9614195354d2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d4aeef7b-4e94-496f-8e01-8ba9e5a14848"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("df2e48cf-9d04-4bbf-a2f0-6fb149b5660a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b2b337d2-ab6a-43e3-81bd-532e29ff85a2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1ac74610-70b4-4fbf-b422-a001a4604a44"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e2c3121c-6984-43b0-ae1d-6f3c271e182e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2f48413a-bb79-4bae-8029-22508148bc3b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
